...
public class ImportAbsen extends BasePage {
    ...
    // private By allertError = By.xpath("//div[contains(@class, 'MuiSnackbarContent-message')]");

    public ImportAbsen(WebDriver driver){
        super(driver);
    ...
    //     return waitingElementReady(allertError).getText();
    // }
}
